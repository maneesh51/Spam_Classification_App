...
Dir = 'D:/Work/Programming/Udemy/Prj1_SpamClassification'
clf_randomforest = pickle.load(open(os.path.join(Dir, 'spam_clf_randomforest.pkl'), 'rb'))
clf_svm = pickle.load(open(os.path.join(Dir, 'spam_clf_svm.pkl'), 'rb'))
